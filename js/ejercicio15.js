function obtenerMayor(x, y) {
  ...
  if (x > y) {
    ...
    return `Los valores son iguales: x = ${x}, e y = ${y}`;
  }
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if ((num1, num2, num3) < 0) {
    ...
    return "Error";
  } else if (num1 > (num2, num3) && (num1, num2, num3) > 0) {
    return "Numero 1 es mayor y positivo";
  } else if (num3 > (num1, num2)) {
    num3 = num3 + 1;
    return `Nuevo valor de num3 = ${num3}`;
  } else {
    return false;
  }
}

console.log(operadoresLogicos(3, 2, 5));
...
function esPrimo(numero) {
  ...
  if (numero % 2 == 0 || numero % 3 == 0 || numero == 0 || numero == 1) {
    return false;
  } else {
    return true;
  }
